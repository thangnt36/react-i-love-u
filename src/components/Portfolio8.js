...
import img1 from './../img/portfolio/img-31.JPG';
import img2 from './../img/portfolio/img-32.jpg';
import img3 from './../img/portfolio/img-33.JPG';
import img4 from './../img/portfolio/img-34.JPG';
import img5 from './../img/portfolio/img-35.JPG';
import img6 from './../img/portfolio/img-36.JPG';
...
export default function Portfolio8() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm 200 Ngày Yêu Của Chúng Ta :3 </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần đầu tiên đôi ta diện ốp đôi :)) </p>
    </div>
    <div className="row">          
