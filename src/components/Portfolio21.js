...
import img1 from './../img/portfolio/img-78.JPG';
import img2 from './../img/portfolio/img-79.JPG';
import img3 from './../img/portfolio/img-80.JPG';
import img4 from './../img/portfolio/img-81.JPG';
import img5 from './../img/portfolio/img-82.JPG';
import img6 from './../img/portfolio/img-83.JPG';

export default function Portfolio21() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Đôi Ta đi cafe Urban</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Một ngày đẹp trời rảnh háng đi chill cafe :v</p>
    </div>
    <div className="row">          
