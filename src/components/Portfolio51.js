...
import img1 from './../img/portfolio/img-175.jpg';
import img2 from './../img/portfolio/img-176.jpg';
import img3 from './../img/portfolio/img-177.jpg';
import img4 from './../img/portfolio/img-178.jpg';
import img5 from './../img/portfolio/img-179.jpg';
import img6 from './../img/portfolio/img-180.jpg';
...
export default function Portfolio51() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh kỉ niệm Honeymoon - Đà Lạt 2025 của chúng ta</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">4 ngày 4 đêm với Đà Lạt mộng mơ, về rồi lại nhớ!</p>
    </div>
    <div className="row">          
