...
import img1 from './../img/portfolio/img-84.JPG';
import img2 from './../img/portfolio/img-85.JPG';
import img3 from './../img/portfolio/img-86.JPG';
import img4 from './../img/portfolio/img-87.JPG';
import img5 from './../img/portfolio/img-88.JPG';
import img6 from './../img/portfolio/img-89.JPG';

export default function Portfolio22() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm 2 Năm chúng ta yêu nhau :3</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Anh yêu em nhất á :3</p>
    </div>
    <div className="row">          
