...
import img1 from './../img/portfolio/img-97.jpg';
import img2 from './../img/portfolio/img-98.JPG';
import img3 from './../img/portfolio/img-99.jpg';
import img4 from './../img/portfolio/img-100.jpg';
import img5 from './../img/portfolio/img-101.jpg';
import img6 from './../img/portfolio/img-102.jpg';

export default function Portfolio25() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Ninh Bình 2022</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Đêm đó cũng tuyệt vời lắm :3</p>
    </div>
    <div className="row">          
