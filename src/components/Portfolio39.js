...
import img1 from './../img/portfolio/img-150.jpg';
import img2 from './../img/portfolio/img-151.jpg';
import img3 from './../img/portfolio/img-152.jpg';
import img4 from './../img/portfolio/img-153.jpg';
import img5 from './../img/portfolio/img-154.jpg';
import img6 from './../img/portfolio/img-155.jpg';

export default function Portfolio39() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm 1500 Ngày Yêu</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Quán nướng ngon nhưng em còn ngon hơn tất cả :v</p>
    </div>
    <div className="row">          
