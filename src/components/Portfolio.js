...
import img2 from './../img/portfolio/img-2.jpg';
import img3 from './../img/portfolio/img-3.jpg';
import img4 from './../img/portfolio/img-4.jpg';
import img5 from './../img/portfolio/img-5.jpg';
import img6 from './../img/portfolio/img-6.jpg';
...
export default function Portfolio() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ Ảnh của bạn DTTH dễ thương này :3</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Kỉ niệm 1 ngày đáng nhớ khi đi aeon mall với bạn của bạn DTTH :v</p>
    </div>
    <div className="row">          
