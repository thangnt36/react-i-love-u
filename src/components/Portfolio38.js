...
export default function Portfolio38() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Lời chúc kỉ niệm 1500 ngày yêu của anh dành cho NIKI :3</h2>
    ...
    <div  className="row portfolio">
      <div className="col-lg-12 col-md-12 col-xs-12 mix development print">
        <ReactPlayer url="https://youtu.be/TbNg4qPsaUg" width="100" height="800px"></ReactPlayer>
      </div>
