...
import img1 from './../img/portfolio/img-7.jpg';
import img2 from './../img/portfolio/img-8.jpg';
import img3 from './../img/portfolio/img-9.jpg';
import img4 from './../img/portfolio/img-10.jpg';
import img5 from './../img/portfolio/img-11.jpg';
import img6 from './../img/portfolio/img-12.jpg';
...
export default function Portfolio2() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ Ảnh của bạn NTT không dễ thương nhưng max hài hước :v </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Kỉ niệm 1 ngày đáng nhớ khi cũng đi aeon mall với bạn của bạn NTT :v</p>
    </div>
    <div className="row">          
