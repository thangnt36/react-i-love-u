...
import img1 from './../img/portfolio/img-91.JPG';
import img2 from './../img/portfolio/img-92.JPG';
import img3 from './../img/portfolio/img-93.JPG';
import img4 from './../img/portfolio/img-94.JPG';
import img5 from './../img/portfolio/img-95.JPG';
import img6 from './../img/portfolio/img-96.JPG';

export default function Portfolio24() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Lễ tốt nghiệp của anh</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lễ tốt nghiệp ai ảnh người đó đẹp á :v</p>
    </div>
    <div className="row">          
