...
import img1 from './../img/portfolio/img-54.JPG';
import img2 from './../img/portfolio/img-55.JPG';
import img3 from './../img/portfolio/img-56.JPG';
import img4 from './../img/portfolio/img-57.JPG';
import img5 from './../img/portfolio/img-58.JPG';
import img6 from './../img/portfolio/img-59.JPG';
...
export default function Portfolio15() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm 1 Năm Của Chúng Ta  </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần đầu tiên đôi ta diện nhẫn đôi :3 </p>
    </div>
    <div className="row">          
