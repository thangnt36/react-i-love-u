...
import img1 from './../img/portfolio/img-110.jpg';
import img2 from './../img/portfolio/img-111.jpg';
import img3 from './../img/portfolio/img-112.jpg';
import img4 from './../img/portfolio/img-113.jpg';
import img5 from './../img/portfolio/img-114.jpg';
import img6 from './../img/portfolio/img-115.jpg';

export default function Portfolio28() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh của Tobby</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Đứa con dễ thương, ngờ nghệch và ngổ ngáo mà chúng ta yêu thương :v</p>
    </div>
    <div className="row">          
