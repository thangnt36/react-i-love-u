...
import img1 from './../img/portfolio/img-172.jpg';
import img2 from './../img/portfolio/img-173.jpg';
import img3 from './../img/portfolio/img-174.jpg';

export default function Portfolio50() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh kỉ niệm ngày sinh nhật 27 tuổi của anh</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Nhờ các bạn chụp cho đôi ta những bức ảnh đẹp này :3</p>
    </div>
    <div className="row">          
