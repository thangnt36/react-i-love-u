...
import img1 from './../img/portfolio/img-72.JPG';
import img2 from './../img/portfolio/img-73.JPG';
import img3 from './../img/portfolio/img-74.JPG';
import img4 from './../img/portfolio/img-75.JPG';
import img5 from './../img/portfolio/img-76.JPG';
import img6 from './../img/portfolio/img-77.JPG';

export default function Portfolio20() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Em bảo vệ Tốt Nghiệp thành công</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Ngay sau khi em bảo vệ xong anh phi về đón em luôn :v</p>
    </div>
    <div className="row">          
