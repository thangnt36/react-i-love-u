...
export default function Portfolio35() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Lời chúc kỉ niệm 4 năm tình yêu của anh dành cho NIKI :3</h2>
    ...
    <div  className="row portfolio">
      <div className="col-lg-12 col-md-12 col-xs-12 mix development print">
        <ReactPlayer url="https://youtu.be/J52CDSqXHII" width="100" height="800px"></ReactPlayer>
      </div>
