...
import img1 from './../img/portfolio/img-122.jpg';


export default function Portfolio31() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bức ảnh Cosplay hồi xuân sinh viên của 2 đứa :v</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Sinh viên năm 8 UET và năm 6 NEU :v </p>
    </div>
    <div className="row">          
