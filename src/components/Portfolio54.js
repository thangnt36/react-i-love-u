...
export default function Portfolio54() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Hát Mừng Sinh Nhật Tuổi 25 Của Em</h2>
    ...
    <div  className="row portfolio">
      <div className="col-lg-12 col-md-12 col-xs-12 mix development print">
        <ReactPlayer url="https://youtube.com/shorts/zYA6z4U_0MM" width="100" height="800px"></ReactPlayer>
      </div>
