...
import img1 from './../img/portfolio/img-19.JPG';
import img2 from './../img/portfolio/img-20.JPG';
import img3 from './../img/portfolio/img-21.JPG';
import img4 from './../img/portfolio/img-22.JPG';
import img5 from './../img/portfolio/img-23.JPG';
import img6 from './../img/portfolio/img-24.JPG';
...
export default function Portfolio5() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Đi Cộng Cafe :v </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Hai đứa rảnh háng đi chọn chụp mấy chục cái app sửa ảnh :))  </p>
    </div>
    <div className="row">          
