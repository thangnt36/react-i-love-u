...
import img1 from './../img/portfolio/img-25.JPG';
import img2 from './../img/portfolio/img-26.JPG';
import img3 from './../img/portfolio/img-27.JPG';
import img4 from './../img/portfolio/img-28.JPG';
import img5 from './../img/portfolio/img-29.JPG';
import img6 from './../img/portfolio/img-30.JPG';
...
export default function Portfolio6() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Đi Bát Tràng Cùng Nhau :3 </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần đầu tiên đôi ta đi phượt :)) </p>
    </div>
    <div className="row">          
