...
import img1 from './../img/portfolio/img-66.jpg';
import img2 from './../img/portfolio/img-67.jpg';
import img3 from './../img/portfolio/img-68.jpg';
import img4 from './../img/portfolio/img-69.jpg';
import img5 from './../img/portfolio/img-70.jpg';
import img6 from './../img/portfolio/img-71.jpg';

export default function Portfolio18() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Sau 2 Tháng Trời Giãn Cách</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần đầu tiên đôi ta diện áo gió đôi :3</p>
    </div>
    <div className="row">          
