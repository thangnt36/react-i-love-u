...
import img1 from './../img/portfolio/img-169.JPG';


export default function Portfolio45() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Đi Ăn Cưới Phạm Thu Hà - Bạn thân của em </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Diện đồ đôi mới luôn nha :3</p>
    </div>
    <div className="row">          
