...
import img1 from './../img/portfolio/img-43.jpg';
...
export default function Portfolio10() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Lần đầu tiên Đôi ta đón năm mới cùng nhau </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần đầu tiên ngắm pháo hoa cùng nhau - Chụp được mỗi 1 bức này :)) </p>
    </div>
    <div className="row">          
