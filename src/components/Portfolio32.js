...
import img1 from './../img/portfolio/img-123.jpg';
import img2 from './../img/portfolio/img-124.jpg';
import img3 from './../img/portfolio/img-125.jpg';
import img4 from './../img/portfolio/img-126.jpg';
import img5 from './../img/portfolio/img-127.jpg';
import img6 from './../img/portfolio/img-128.jpg';

export default function Portfolio32() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Hải Phòng 2023</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Nhiều đồ ăn ngon và cả em cũng ngon :v</p>
    </div>
    <div className="row">          
