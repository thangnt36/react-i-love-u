...
import img1 from './../img/portfolio/img-129.jpg';
import img2 from './../img/portfolio/img-130.jpg';
import img3 from './../img/portfolio/img-131.jpg';
import img4 from './../img/portfolio/img-132.jpg';
import img5 from './../img/portfolio/img-133.jpg';
import img6 from './../img/portfolio/img-134.jpg';

export default function Portfolio33() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Tobby part 2</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Vẫn là nó và những bức ảnh ngốc ngếch :v</p>
    </div>
    <div className="row">          
