...
import img1 from './../img/portfolio/img-157.jpg';
import img2 from './../img/portfolio/img-158.jpg';
import img3 from './../img/portfolio/img-159.jpg';
import img4 from './../img/portfolio/img-160.jpg';
import img5 from './../img/portfolio/img-161.jpg';
import img6 from './../img/portfolio/img-162.jpg';

export default function Portfolio41() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Cưới Của Đôi Ta</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Ngày Đôi Ta Đẹp Nhất!</p>
    </div>
    <div className="row">          
