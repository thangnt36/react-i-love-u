...
import img1 from './../img/portfolio/img-50.JPG';
import img2 from './../img/portfolio/img-51.JPG';
import img3 from './../img/portfolio/img-52.JPG';
...
export default function Portfolio9() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Lần Thứ 2 đi Highland Du Thuyền </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần thứ 2 lênh đênh trên mặt hồ :)) </p>
    </div>
    <div className="row">          
    ...
    <div  className="row portfolio">
      ...
      <div className="col-lg-12 col-md-12 col-xs-12 mix development design">
        <div className="portfolio-item">
          <div className="shot-item">
            <img src={img4} alt="" /> 
            <div className="single-content">
