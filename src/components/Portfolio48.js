...
export default function Portfolio48() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Lời chúc Valentine 2025 của Anh!</h2>
    ...
    <div  className="row portfolio">
      <div className="col-lg-12 col-md-12 col-xs-12 mix development print">
        <ReactPlayer url="https://youtube.com/shorts/QXC11gRqFtw" width="100" height="800px"></ReactPlayer>
      </div>
