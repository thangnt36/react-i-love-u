...
import img1 from './../img/portfolio/img-37.JPG';
import img2 from './../img/portfolio/img-38.JPG';
import img3 from './../img/portfolio/img-39.JPG';
import img4 from './../img/portfolio/img-40.JPG';
import img5 from './../img/portfolio/img-41.JPG';
import img6 from './../img/portfolio/img-42.JPG';
...
export default function Portfolio9() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Chuyến Đi Phượt Thứ 2 của Đôi Ta - Ba Vì 1 ngày toàn Mưa </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần thứ 2 đi phượt lại ướt sũng :)) </p>
    </div>
    <div className="row">          
