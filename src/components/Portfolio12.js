...
import img1 from './../img/portfolio/img-44.JPG';
import img2 from './../img/portfolio/img-45.JPG';
import img3 from './../img/portfolio/img-46.JPG';
import img4 from './../img/portfolio/img-47.JPG';
import img5 from './../img/portfolio/img-48.JPG';
import img6 from './../img/portfolio/img-49.JPG';
...
export default function Portfolio9() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Lần đi Cafe Lối Nhỏ - Không gian cực Chill </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Nhiều góc sống ảo quá nên lựa mới không hết :)) </p>
    </div>
    <div className="row">          
