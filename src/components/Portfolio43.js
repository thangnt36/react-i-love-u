...
import img1 from './../img/portfolio/img-163.jpg';
import img2 from './../img/portfolio/img-164.jpg';
import img3 from './../img/portfolio/img-165.jpg';
import img4 from './../img/portfolio/img-166.jpg';
import img5 from './../img/portfolio/img-167.jpg';
import img6 from './../img/portfolio/img-168.jpg';

export default function Portfolio43() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh ngày ăn Hỏi và Cưới Của Đôi Ta</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Ngày Trọng Đại Nhất Của Đôi Ta</p>
    </div>
    <div className="row">          
