...
import img1 from './../img/portfolio/img-116.jpg';
import img2 from './../img/portfolio/img-117.jpg';
import img3 from './../img/portfolio/img-118.jpg';
import img4 from './../img/portfolio/img-119.jpg';
import img5 from './../img/portfolio/img-120.jpg';
import img6 from './../img/portfolio/img-121.jpg';

export default function Portfolio30() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Hạ Long 2023</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Một chuyến đi đáng nhớ có vui, có buồn, có cả những cảm xúc mãnh liệt mà ta trao nhau!</p>
    </div>
    <div className="row">          
