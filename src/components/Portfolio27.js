...
import img1 from './../img/portfolio/img-104.jpg';
import img2 from './../img/portfolio/img-105.jpg';
import img3 from './../img/portfolio/img-106.jpg';
import img4 from './../img/portfolio/img-107.jpg';
import img5 from './../img/portfolio/img-108.jpg';
import img6 from './../img/portfolio/img-109.jpg';

export default function Portfolio27() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Tam Đảo 2023</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">1 chuyến đi thú vị của 2 đứa</p>
    </div>
    <div className="row">          
