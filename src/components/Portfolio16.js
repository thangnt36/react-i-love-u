...
import img1 from './../img/portfolio/img-60.JPG';
import img2 from './../img/portfolio/img-61.JPG';
import img3 from './../img/portfolio/img-62.JPG';
import img4 from './../img/portfolio/img-63.JPG';
import img5 from './../img/portfolio/img-64.JPG';
import img6 from './../img/portfolio/img-65.JPG';
...
export default function Portfolio16() {
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Lần Thứ 3 Đi Phượt của Chúng Ta - Mai Châu Khung Cảnh Tuyệt Đẹp</h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Lần đầu tiên đôi ta ấy ấy :v </p>
    </div>
    <div className="row">          
