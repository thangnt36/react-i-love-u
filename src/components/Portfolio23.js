...
import img1 from './../img/portfolio/img-90.JPG';


export default function Portfolio23() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Lễ tốt nghiệp của em </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Sau đó chúng ta ấy rất nhiều :)) </p>
    </div>
    <div className="row">          
