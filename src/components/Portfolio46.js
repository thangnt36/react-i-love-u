...
import img1 from './../img/portfolio/img-170.jpg';


export default function Portfolio46() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Bộ ảnh Kỉ Niệm Giáng Sinh 2024 </h2>
      <span>NTT LOVE DTHH</span>
      <p className="section-subtitle">Đi ăn, đi chơi và đi cafe</p>
    </div>
    <div className="row">          
