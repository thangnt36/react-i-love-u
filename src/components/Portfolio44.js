...
export default function Portfolio44() {
    return (
        <div>
  ...
  <div className="container">
    <div className="section-header">          
      <h2 className="section-title">Video Ngày Ăn Hỏi Và Ăn Cưới Của Đôi Ta</h2>
    ...
    <div  className="row portfolio">
      <div className="col-lg-12 col-md-12 col-xs-12 mix development print">
        <ReactPlayer url="https://youtu.be/acQSYOTx5Fg" width="100" height="800px"></ReactPlayer>
      </div>
